...
namespace VCoin.Droid
{
    public class BrowseFragment : Android.Support.V4.App.Fragment, IFragmentVisible
    {
        ...
        public static bool HasNotified { get; set; }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var main = (this.Activity as MainActivity);
            if(!string.IsNullOrWhiteSpace(main.Link))
            {
                var item = new Item
                {
                    Text = main.Link,
                    Description = main.Rate
                    //Text = MyFireMessagingService.Body,
                    //Description = MyFireMessagingService.Body
                };
